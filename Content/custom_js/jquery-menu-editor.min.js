    ...
    e.fn.sortableLists = function (t) {
        var s = e("body").css("position", "relative"),
            l = {
                ...
                hintWrapperClass: "", hintWrapperCss: {}, baseClass: "", baseCss:
                {
                    position: "absolute",
                    top: 0 - parseInt(s.css("margin-top")),
                    left: 0 - parseInt(s.css("margin-left")),
                    margin: 0,
                    padding: 0, "z-index": 2500
                }, opener:
                {
                    active: !1,
                    open: "",
                ...
                listsClass: "", listsCss: {}, insertZone: 50, insertZonePlus: !1, scroll: 20, ignoreClass: "", isAllowed: function (e, t, s) { return !0 }, onDragStart: function (e, t) { return !0 },
                onChange: function (e) { return !0 }, complete: function (e) { return !0 }
            }, n = e.extend(!0, {}, l, t),
            o = e("<" + n.listSelector + " />").prependTo(s).attr("id", "sortableListsBase").css(n.baseCss).addClass(n.listsClass + " " + n.baseClass),
            ...
            c = e("<span />").addClass("sortableListsOpener " + n.opener.openerClass).css(n.opener.openerCss).on("mousedown touchstart", function (t) {
        ...
        var d = {
            isDragged: !1, isRelEFP: null, oEl: null, rootEl: null, cEl: null, upScroll: !1, downScroll: !1, pX: 0, pY: 0, cX: 0, cY: 0, isAllowed: !0,
            e: { pageX: 0, pageY: 0, clientX: 0, clientY: 0 }, doc: e(document), win: e(window)
        }; if (n.opener.active) {
            ...
            e(this).find("li").each(function () { var t = e(this); t.children(n.listSelector).length && (c.clone(!0).prependTo(t.children("div").first()), t.hasClass("sortableListsOpen") ? L(t) : E(t)) })
        } return this.on("mousedown touchstart", function (t) {
            var s = e(t.target); if (!(!1 !== d.isDragged || n.ignoreClass && s.hasClass(n.ignoreClass))) {
                t.preventDefault(), "touchstart" === t.type && v(t); var l = s.closest("li"),
                    a = e(this); l[0] && (n.onDragStart(t, l),
                        function (t, s, l) {
                            d.isDragged = !0;
                            var a = parseInt(s.css("margin-top")),
                                ...
                                v = s.offset(), b = s.innerHeight();
                            d.rootEl = { el: l, offset: l.offset(), rootElClass: l.attr("class") },
                                d.cEl = { el: s, mT: a, mL: f, mB: c, mR: h, offset: v }, d.cEl.xyOffsetDiff = { X: t.pageX - d.cEl.offset.left, Y: t.pageY - d.cEl.offset.top }, d.cEl.el.addClass("sortableListsCurrent " + n.currElClass), s.before(i); var g = d.placeholderNode = e("#sortableListsPlaceholder"); s.css({ width: s.width(), position: "absolute", top: v.top - a, left: v.left - f }).prependTo(o), g.css({ display: "block", height: b }), r.css("height", b), d.doc.on("mousemove touchmove", p).on("mouseup touchend touchcancel", u)
                        }(t, l, a))
            }
        });
        ...
        "html" === e.opener.as ? t.html(e.opener.close) : "class" === e.opener.as && t.addClass(e.opener.close).removeClass(e.opener.open)
...
function MenuEditor(e, t)
{
    var s = $("#" + e).data("level", "0"),
        l = {
            ...
            listOptions: {
                ...
                opener: {
                    as: "html", close: '<i class="fas fa-minus"></i>', open: '<i class="fas fa-plus"></i>',
                ...
                complete: function (e)
                {
                    return MenuEditor.updateButtons(s),
                        s.updateLevels(0), !0
                }, isAllowed: function (e, t, s) { return h(e, s) }
            }
        };
    $.extend(!0, l, t);
    console.log($("#" + e + "_icon").tagName);
    var n = null, o = !0, i = null, r = null,
        a = l.IconPicker,
        c = (t = l.listOptions, console.trace()/*,$("#" + e + "_icon").Iconpicker(a)*/);
    function d() {
        i[0].reset(),
    ...
    {
        if (l.maxLevel < 0) return !0; var s = 0, n = e.find("ul").length; return s = 0 == t.length ? 0 : parseInt(t.parent().data("level")) + 1,
            console.log(s + n), s + n <= l.maxLevel
    }
    s.sortableLists(l.listOptions), c.on("change", function (e) { i.find("[name=icon]").val(e.icon) }), $(document).on("click", ".btnRemove", function (t)
    {
